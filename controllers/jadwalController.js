...
// ini untuk tanggal donor darahnya menjadi besok bukan hari ini
// exports.postJadwalDaftar = async (req, res) => {
//   try {
//     const { id_user, id_lokasi_pmi, id_gol_darah } = req.body;
...
//       id_gol_darah,
//       id_lokasi_pmi,
//       tgl_donor: tomorrow, // Set tanggal_donor to tomorrow
//       status: 1, // 1 Register
//     });
...
//         gol_darah: golDarah.gol_darah,
//         lokasi_pmi: lokasiPmi.nama,
//         tanggal_donor: tomorrow.toISOString().split("T")[0], // Convert to ISO string and format as date
//         message: "Donor registration successful for tomorrow",
//       },
//     });
//   } catch (error) {
//     console.error(error);
